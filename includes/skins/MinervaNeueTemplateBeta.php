<?php
/**
 * MinervaNeueTemplateBeta.php
 */

/**
 * Alternative MinervaNeue template sent to users who have opted into the
 * beta mode via Special:MobileOptions
 */
class MinervaNeueTemplateBeta extends MinervaNeueTemplate {
	/**
